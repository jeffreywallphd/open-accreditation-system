...
import { EVID_SERVICE, EvidenceManagementModule } from '../evidence-management/evidence-management.module.js';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: WF_SERVICE,
      inject: [WF_REPOSITORY_TOKENS.reviewCycles, WF_REPOSITORY_TOKENS.reviewWorkflows, ORG_REPOSITORY_TOKENS.institutions, EVID_SERVICE],
      useFactory: (cycles, workflows, institutions, evidenceManagement) =>
